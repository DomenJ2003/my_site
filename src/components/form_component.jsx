    ...
    return(
        <>
            <div className="text-center">
                  ...
                  <input type="text" id="name" name="from_name" className="form-control mb-4 input-name" ref={nameRef} />
                  <span className="floating-label-name" >Name</span>
                  <input type="text" id="mail" name="from_email" className="form-control mb-4 input-email" ref={senderMailRef} />
                  <span className="floating-label-email" >E-mail</span>
                  <div className="form-group">
                      <textarea className="form-control text-for-email text-for-msg" rows="3" name="message" ref={bodyRef} ></textarea>
